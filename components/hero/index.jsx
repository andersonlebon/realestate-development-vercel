...
function HeroSectionStyleTwo({ agencies }) {
              ...
              >
                <div
                  className={`ltn__slide-item-inner ${
                    agency.variationLeft ? "text-right text-end" : ""
                  }`}
                >
                      ...
                      <Col xs={12} className="align-self-center">
                        <div className="slide-item-info">
                          <div className="slide-item-info-inner ltn__slide-animation">
                            <h6 className="slide-sub-title animated flex items-center">
                              <span>
                                <FaHome />
                              </span>
                              Top Agencies
                            ...
                            <div className="slide-brief animated">
                              <p>{agency.header_intro}</p>
                            </div>
                            <div className="btn-wrapper flex animated">
                              <Link
                                href={`/agencies/${agency.id}/properties`}
                        ...
                        {agency.properties_count !== 0 && <div
                          className={`slide-item-img ${
                            agency.variationLeft ? "slide-img-left" : ""
                          }`}
                        >
                          <img src={getRadom(getRadom(agency.properties).images).url} alt="#" />
                        </div>}
                      </Col>
                    </Row>
                  </Container>
